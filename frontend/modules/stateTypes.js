export const globalMutationTypes = {
  ...
  SET_SELECTED_FLOWCAPT_STATION: 'SET_SELECTED_FLOWCAPT_STATION',
...
export const mapMutationTypes = {
  ...
  SET_FLOWCAPT_VISIBILITY: 'SET_FLOWCAPT_VISIBILITY',
  SET_MASSIFS_VISIBILITY: 'SET_MASSIFS_VISIBILITY',
  SET_NIVO_STATION_VISIBILITY: 'SET_NIVO_STATION_VISIBILITY',
  SET_SLOPES_VISIBILITY: 'SET_SLOPES_VISIBILITY',
  SET_SKI_TRACKS_VISIBILITY: 'SET_SKI_TRACKS_VISIBILITY',
  SET_SLOPES_OPACITY: 'SET_SLOPES_OPACITY',
  SET_VISIBILITY: 'SET_VISIBILITY',
  SET_SELECTED_FLOWCAPT_STATION: 'SET_SELECTED_FLOWCAPT_STATION',
  SET_SELECTED_MASSIF: 'SET_SELECTED_MASSIF',
  SET_SELECTED_NIVO_STATION: 'SET_SELECTED_NIVO_STATION',
  ADD_TO_SELECTED_FEATURES: 'ADD_TO_SELECTED_FEATURES',
  REMOVE_FROM_SELECTED_FEATURES: 'REMOVE_FROM_SELECTED_FEATURES'
}
