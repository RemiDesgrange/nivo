...
_featurecollection_json = os.path.join(_current_path, '../json_schema/FeatureCollection.json')


Feature = SchemaModel('Feature', json.load(open(_feature_json)))
FeatureCollection = SchemaModel('FeatureCollection', json.load(open(_featurecollection_json)))