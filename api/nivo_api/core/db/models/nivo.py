...
NivoSensorStation = AbstractSpatialTable(
    "nivo_sensor_station",
    metadata,
...
NivoRecord = AbstractTable(
    ...
    Column("nr_nivo_sensor", UUID(as_uuid=True), nullable=False),
    ForeignKeyConstraint(("nr_nivo_sensor",), ("nivo_sensor_station.nss_id",)),
)

# Since all the field are not quite obvious. Document the field
NivoRecordDescription = AbstractTable(
    "nivo_record_description",
    metadata,
